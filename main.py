...
def Friend(session: requests.Session, token: str, username: str):
    headers = {
        "authority": "discord.com",
        "method": "POST",
        "path": "/api/v9/auth/login",
    ...
    r = session.post("https://discord.com/api/v9/users/@me/relationships", headers=headers, data=json.dumps(payload))
